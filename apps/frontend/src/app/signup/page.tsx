...
export default function Signup() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            const res = await axios.post(`${API_URL}/auth/signup`, { email, name, password });
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0c] text-white flex items-center justify-center p-6">
            ...
            >
                ...
                <p className="text-slate-400 text-center mb-10 text-sm">Join Unrole and automate your career growth.</p>
